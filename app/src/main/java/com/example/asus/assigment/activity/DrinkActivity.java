...
import com.example.asus.assigment.Adapter.Adapter_tablayout_Drink;
...
// finally change the color
    ...
    private void initaddcontroll() {
        ...
        mViewPager.setAdapter(new Adapter_tablayout_Drink(getSupportFragmentManager()));
