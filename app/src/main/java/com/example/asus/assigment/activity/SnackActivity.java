...
import com.example.asus.assigment.Adapter.Adapter_tablayout_Snack;
...
// finally change the color
    ...
    private void initaddcontroll() {
        ...
        mViewPager.setAdapter(new Adapter_tablayout_Snack(getSupportFragmentManager()));
